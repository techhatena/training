...
import { parseImportedJSON } from '@/lib/exportTSX';
...
export default function Home() {
  ...
  const handleImportJson = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Use the parseImportedJSON function which handles both old and new formats
      ...
      // Save to database with Craft.js format
